...
{   
    ...
    if (configuration == 0) {
		...
		//ApplicationContainer clientApp = onOffHelper.Install(CSMA2_nodes.Get(2));
		//clientApp.Start(Seconds(1.0));
		//clientApp.Stop(Seconds(10.0));
			
		ApplicationContainer clientApps;
		//AddressValue remoteAddress(InetSocketAddress(CSMA2_interfaces.GetAddress(2), port));
		AddressValue remoteAddress(InetSocketAddress("192.128.2.2", port));
		//AddressValue remoteAddress(InetSocketAddress("192.168.2.3", port));//probabilmente è questo l'indirizzo
        ...
        // AddressValue remoteAddress(InetSocketAddress(csma
