...
main(int argc, char* argv[])
{
    ...
    if (configuration == 1)
    {
        ...
        //        AddressValue remoteAddress1 (InetSocketAddress (CSMA2_interfaces.GetAddress(1),
        //        port1));;
        ...
        //        AddressValue remoteAddress2 (InetSocketAddress (CSMA2_interfaces.GetAddress(2),
        //        port2));;
        ...
        //AGGIORNATO
        n2n3.EnablePcap("task1-configuration1-n3.pcap", n2n3_ND.Get(1));
        CSMA1.EnablePcap("task1-configuration1-n0.pcap", CSMA1_ND.Get(0)); // CSMA_1.EnablePcap();
        CSMA2.EnablePcap("task1-configuration1-n7.pcap", CSMA2_ND.Get(0));
        //      CSMA2.EnablePcap("Csma2_test",CSMA1_ND.Get(1),true);
        //       CSMA2.EnablePcap("Csma2_test",CSMA1_ND.Get(2),true);
        AsciiTraceHelper ascii;

        starN5.EnableAscii(ascii.CreateFileStream("task1-configuration1-n5.tr"), NodeContainer(star.GetHub()));
        CSMA2.EnableAscii(ascii.CreateFileStream("task1-configuration1-n9.tr"),NodeContainer(CSMA2_nodes.Get(2)));
        CSMA1.EnableAscii(ascii.CreateFileStream("task1-configuration1-n0.tr"), NodeContainer(CSMA1_nodes.Get(0)));
        CSMA2.EnableAscii(ascii.CreateFileStream("task1-configuration1-n8.tr"), NodeContainer(CSMA1_nodes.Get(1)));
    }
