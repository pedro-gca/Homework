...
main(int argc, char* argv[])
{
    ...
    if (configuration == 0)
    {
        ...
        AddressValue remoteAddress(
            InetSocketAddress(star.GetHubIpv4Address(2),
                              port)); // Ho cambiato nuovamente il parametro,non definitivo

        // AddressValue remoteAddress(InetSocketAddress(GetHubIpv4Address(CSMA2_nodes.Get(2)) ,
        // port));
        ...
        n2n3.EnablePcap("task1-configuration0-n3.pcap",
                        n2n3_ND.Get(1),
                        true); // in questo modo vengono tracciati i dispositivi
        CSMA1.EnablePcap("task1-configuration0-n0.pcap",
                         CSMA1_ND.Get(0),
                         true); // di tutti nodi ma a noi servono soltanto su n0 n3 n7
        ...
        starN5.EnableAscii(ascii.CreateFileStream("task1-configuration0-n5.tr"),
                           NodeContainer(star.GetHub()));
        CSMA2.EnableAscii(ascii.CreateFileStream("task1-configuration0-n9.tr"),
                          NodeContainer(CSMA2_nodes.Get(2)));
    }
    ...
    if (configuration == 1)
    {
        ...
        n2n3.EnablePcap("task1-configuration1-n3.pcap",
                        n2n3_ND.Get(1),
                        true); // in questo modo vengono tracciati i dispositivi
        CSMA1.EnablePcap("task1-configuration1-n0.pcap",
                         CSMA1_ND.Get(0),
                         true); // di tutti nodi ma a noi servono soltanto su n0 n3 n7
        ...
        starN5.EnableAscii(ascii.CreateFileStream("task1-configuration1-n5.tr"),
                           NodeContainer(star.GetHub()));
        CSMA2.EnableAscii(ascii.CreateFileStream("task1-configuration1-n9.tr"),
                          NodeContainer(CSMA2_nodes.Get(2)));
        CSMA1.EnableAscii(ascii.CreateFileStream("task1-configuration1-n0.tr"),
                          NodeContainer(CSMA1_nodes.Get(0)));
        CSMA2.EnableAscii(ascii.CreateFileStream("task1-configuration1-n8.tr"),
                          NodeContainer(CSMA1_nodes.Get(1)));
    }
    ...
    if (configuration == 2)
    {
        ...
        starN5.EnableAscii(ascii.CreateFileStream("task1-configuration2-n5.tr"),
                           NodeContainer(star.GetHub()));
        CSMA1.EnableAscii(ascii.CreateFileStream("task1-configuration2-n8.tr"),
                          NodeContainer(CSMA1_nodes.Get(2)));
        CSMA2.EnableAscii(ascii.CreateFileStream("task1-configuration2-n8.tr"),
                          NodeContainer(CSMA2_nodes.Get(1)));
        CSMA2.EnableAscii(ascii.CreateFileStream("task1-configuration2-n9.tr"),
                          NodeContainer(CSMA2_nodes.Get(2)));
    }
